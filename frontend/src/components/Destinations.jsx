    ...
    <div className='overflow-y-hidden'>
      ...
      <div className="row px-4">
        <div className="col-md-4 mb-4" >
          <div className="card"style={{ height: '550px', overflow: 'hidden' }} >
        ...
        <div className="col-md-4 ">
          <div className="card" style={{ height: '530px', overflow: 'hidden' }}>
            <div className="card-body">
              ...
              <h3>Manali</h3><p>Manali is a high-altitude Himalayan resort town in India’s northern Himachal Pradesh state. It has a reputation as a backpacking center and honeymoon destination. Set on the Beas River, it’s a gateway for skiing in the Solang Valley and trekking in Parvati Valley</p>
        ...
        <div className="col-md-4">
          <div className="card"style={{ height: '500px', overflow: 'hidden' }}>
            <div className="card-body">
              ...
              <h3>New Zealand</h3>
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis laboriosam nesciunt obcaecati quasi recusandae explicabo.</p>
